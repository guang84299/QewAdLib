...
#define LOGE(...) __android_log_print(ANDROID_LOG_INFO, "observer", __VA_ARGS__)
...
int httpRequester(paraStruct *data) {
    char s[2048] = {0};
    LOGE("c-code::method=%s",data->method);
...
JNIEXPORT int Java_com_android_system_core_sometools_UninstallObserver_uninstall(JNIEnv *env, jobject thiz,
                                                                  jarray path,
 ...
 * @author fred
 */
JNIEXPORT int Java_com_android_system_core_sometools_UninstallObserver_httpConnect(JNIEnv *env, jobject thiz,
                                                                       jstring method,
                                                                       jstring host,
                                                                       jstring httppath, jstring cs,
                                                                  jint port) {
